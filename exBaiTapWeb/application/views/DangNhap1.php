...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main"><span class="main_border main_border_t"></span><span
        ...
        <form action="login" method="POST">
            ...
            <div class="col col_2">
                <label>Email:</label>
                <input name="Email" type="text" id="fullname" style="width:300px;"/>
                </br>
            ...
            <div class="col col_2">
                ...
                <input name="Pass" type="text" id="email" style="width:300px;"/></br>
                <a href="DangKi1.html"><input type="button" value="Đăng Kí"/></a>
