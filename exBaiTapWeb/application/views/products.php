    ...
    <div id="tooplate_main"><span class="main_border main_border_t"></span><span
        ...
        <div id="content">
            ...
            <table width="800px" cols="0" cellspacing="0" cellpadding="5">
                <tr bgcolor="#ddd">
                    <th width="75" align="right">Mã Hàng</th>
                    <th width="75" align="right">Tên Hàng</th>
                    <th width="220" align="left">Hình</th>
                    <th width="150" align="left">Mô Tả</th>
            ...
            <p class="right"><a href="addProduct" class="button">Thêm</a></p>
