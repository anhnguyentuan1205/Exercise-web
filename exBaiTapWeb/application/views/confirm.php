...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main"><span class="main_border main_border_t"></span><span
        ...
        <div class="col col_1">
            ...
            <div class="col col_2">
                <p style="color:black;">Tên người nhân: <?php echo $name; ?></p>
                <p style="color:black;">Địa chỉ: <?php echo $diachi; ?>  </p>
            </div>

            <div class="col col_2">
                <p style="color:black;">Điện thoại người nhận: <?php echo $dt; ?></p>
                <p style="color:black;">Giá tiền: <?php echo $count;?> </p>
                <a href="index" class="button" style="color:black;">Xác nhận</a>
            </div>
    </div>
    <div class="col col_1">
