        ...
        <form action="confirm" method="POST" enctype='multipart/form-data'>
            <div class="col col_2">
                <label>Tên người nhận:<label>
                        <input name="ten" type="text" id="fullname" style="width:300px;"/>
                        <label>Địa chỉ:</label>
                        <input name="diachi" type="text" id="address" style="width:300px;"/>
            </div>

            <div class="col col_2">
                <label>Emaill:</label>
                <input name="email" type="text" id="country" style="width:300px;"/>
                <label>Số điện thoại:</label>
                <input name="dienthoai" type="text" id="country" style="width:300px;"/>
                </br>
